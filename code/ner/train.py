...
para entrenar los modelos y, además, los evalúa y guarda: los modelos, los parámetros y las métricas.
"""
...
def train(model, optimizer, loss_fn, data_iterator, metrics, params, num_steps):
    ...
    for i in t:
        ...
        # Obtenemos los indices de los tokens de las frases y los índices de las etiquetas de las frases
        # para ese *batch*
        train_batch, labels_batch = next(data_iterator)

        # Pasamos la información de los tokens del *batch* al modelo, que ejecutará el forward y devolverá las
...
def train_and_evaluate(model, train_data, val_data, optimizer, loss_fn, metrics, params, model_dir, restore_file=None):
    ...
    # Si existe archivo de restauración
    ...
    for epoch in range(params.num_epochs):
        ...
        if is_best:
            ...
            # Se actualiza el valor del mejor valor obtenido para la métrica `accuracy`
